...
export const parseStringify = (value: any) => {
  try {
    console.log("parseStringify received value:", value); // Log the received value
    if (value === undefined) {
      console.error("parseStringify received undefined value");
      return null; // Handle undefined case appropriately
    }
